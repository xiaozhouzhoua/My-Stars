...
*   [kaixinbaba/hg-tui](https://github.com/kaixinbaba/hg-tui) - 使用 TUI 界面去浏览 HelloGitHub 网站
...
*   [lanzhiwang/awesome-huzhi](https://github.com/lanzhiwang/awesome-huzhi) - 学习心得，笔记，资源汇总等
...
*   [borisuvarov/cursed\_snake](https://github.com/borisuvarov/cursed_snake) - A simple console game (Python 3)
...
*   [kweatherman/Folcolor](https://github.com/kweatherman/Folcolor) - Windows explorer folder coloring utility
...
*   [rpcapd-linux/rpcapd-linux](https://github.com/rpcapd-linux/rpcapd-linux) - rpcapd utility modified to compile under linux
...
*   [guyijie1211/JustLive-Api](https://github.com/guyijie1211/JustLive-Api) - 一个整合国内多个直播平台内容的网站（后端）
...
*   [lalyos/jfiglet](https://github.com/lalyos/jfiglet) - Java implementation of FIGfonts (http://www.figlet.org/) to create ascii art banners
...
*   [aliakh/demo-java-completablefuture](https://github.com/aliakh/demo-java-completablefuture) - 'Asynchronous programming in Java with CompletableFuture' article and source code.
...
*   [yjmyzz/spring-boot-dubbo-demo](https://github.com/yjmyzz/spring-boot-dubbo-demo) - spring boot 集成dubbo示例工程

*   [Mastering-Spring-MVC-4/mastering-spring-mvc4](https://github.com/Mastering-Spring-MVC-4/mastering-spring-mvc4) - Source code of the book "Mastering Spring MVC 4"
...
*   [greenmail-mail-test/greenmail](https://github.com/greenmail-mail-test/greenmail) - Official master for the Greenmail project
...
*   [AliyunContainerService/docker-machine-driver-aliyunecs](https://github.com/AliyunContainerService/docker-machine-driver-aliyunecs) - Aliyun (Alibaba Cloud) ECS Driver of Docker Machine
...
*   [liaoliao666/translate-ext](https://github.com/liaoliao666/translate-ext) -
...
*   [y-not-u/tinycodes](https://github.com/y-not-u/tinycodes) - A code snippet box.
...
*   [sindresorhus/emoj](https://github.com/sindresorhus/emoj) - Find relevant emoji from text on the command-line :open\_mouth: :sparkles: :raised\_hands: :horse: :boom: :see\_no\_evil:
...
*   [oktadev/okta-spring-boot-2-angular-5-example](https://github.com/oktadev/okta-spring-boot-2-angular-5-example) - A Cool Cars Example that showcases Spring Boot 2, Angular 5, and Okta's Support for both.
...
*   [JimmyWan2022/r2s-best-practice](https://github.com/JimmyWan2022/r2s-best-practice) - openwrt r2s实践
...
*   [codemutex/NextSSH-userland](https://github.com/codemutex/NextSSH-userland) - NextSSH 及相关服务用户反馈社区。
...
*   [Chenyu-otf/chenyuluoyan\_thin](https://github.com/Chenyu-otf/chenyuluoyan_thin) - 「辰宇落雁體」是我與韋辰在學校的自主學習計畫，由韋辰負責書寫，我進行後製而成。手寫字型就像是我們將字詞複寫於紙上，讓字跡留下，以這種近似雋永的形式封裝，使被複寫的日常沒有保質期，也像是一種永恆的召喚，在任何無法抵達的以後，都能為你書寫成篇。
...
*   [balamaci/awesome-articles](https://github.com/balamaci/awesome-articles) - Curated lists of articles on different topics
...
*   [skyline75489/what-happens-when](https://github.com/skyline75489/what-happens-when) - An attempt to answer the age old interview question "What happens when you type google.com into your browser and press enter?"

*   [HongyuS/Bilibili-Mac](https://github.com/HongyuS/Bilibili-Mac) - Bilibili 官方桌面版 macOS 移植
...
*   [murphysecurity/murphysec-jetbrains-plugin](https://github.com/murphysecurity/murphysec-jetbrains-plugin) - MurphySec plugin for JetBrains IDEs, identify and fix open source vulnerabilities in your project. 墨菲安全推出的一款 JetBrains IDE 插件，可以用来识别并修复项目中的开源组件漏洞
...
*   [wenyanjun/free-coding](https://github.com/wenyanjun/free-coding) - idea, webStorm, pycharm, phpStorm 激活码 QQ技术交流③群 1093476453

*   [unlock-music/unlock-music](https://github.com/unlock-music/unlock-music) - Unlock encrypted music file in browser. 在浏览器中解锁加密的音乐文件。

*   [learnbyexample/vim\_reference](https://github.com/learnbyexample/vim_reference) - :q   Vim reference guide for beginner to intermediate users
...
*   [duanluan/ultimate-resources-zh-hans](https://github.com/duanluan/ultimate-resources-zh-hans) - 电子书、软件、Chrome 扩展、网站等推荐。

*   [0xHJK/CleanApps](https://github.com/0xHJK/CleanApps) - 让互联网为用户服务，而不是把用户变成互联网的产品
...
*   [mybatis/parent](https://github.com/mybatis/parent) - The MyBatis parent POM which has to be inherited by all MyBatis modules
...
*   [zxiaofan/JavaBooks](https://github.com/zxiaofan/JavaBooks) - 网络收集的JAVA学习资料，仅作学习交流使用，列表中没有的书籍，可前往公众号【zxiaofan】留言
...
*   [waylau/h2-database-doc](https://github.com/waylau/h2-database-doc) - It is a book about the H2 Database Engine.《H2 Database 教程》
...
*   [hzh-cocong/SaveTabs](https://github.com/hzh-cocong/SaveTabs) - Save brower tabs as a file so that you can open them again just like a workspace.
...
*   [Devifish/light-tab-page](https://github.com/Devifish/light-tab-page) - 🚀 Lightweight Browser new tab extension  |  一款轻量简洁的新标签页浏览器插件
...
*   [ongmanibaimihong/book](https://github.com/ongmanibaimihong/book) - 个人认为对技术提升很不错的书
...
*   [nebula-plugins/gradle-info-plugin](https://github.com/nebula-plugins/gradle-info-plugin) - Plugin to gather information about the environment

*   [nebula-plugins/gradle-extra-configurations-plugin](https://github.com/nebula-plugins/gradle-extra-configurations-plugin) - Gradle plugin introducing a provided dependency configuration and marking a dependency as optional.
